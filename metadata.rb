...
source_url        'https://github.com/schubergphilis/notepadplusplus' if respond_to?(:source_url)
issues_url        'https://github.com/schubergphilis/notepadplusplus/issues' if respond_to?(:issues_url)
